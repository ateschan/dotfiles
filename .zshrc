...
plugins=(zsh-autosuggestions zsh-syntax-highlighting fast-syntax-highlighting colored-man-pages ripgrep rust golang archlinux git)
...
# History menu.
zstyle ':autocomplete:history-search-backward:*' list-lines 6
